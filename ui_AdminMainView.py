...
################################################################################
## Form generated from reading UI file 'AdminMainView.ui'
##
...
class Ui_AdminMainWindow(object):
    def setupUi(self, AdminMainWindow):
        ...
        self.admin_main_panel = QWidget(AdminMainWindow)
        self.admin_main_panel.setObjectName(u"admin_main_panel")
        self.verticalLayout = QVBoxLayout(self.admin_main_panel)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.menu_bar = QFrame(self.admin_main_panel)
...
"")
        ...
        self.horizontalLayout_8.addWidget(self.bt_min)
...
"")
        ...
        self.horizontalLayout_8.addWidget(self.bt_restore)
...
"")
        ...
        self.horizontalLayout_8.addWidget(self.bt_max)
...
"")
        ...
        self.horizontalLayout_8.addWidget(self.bt_close)


        self.verticalLayout.addWidget(self.menu_bar)

        self.main_panel = QFrame(self.admin_main_panel)
...
"}")
        ...
        self.bt_task = QPushButton(self.lateral_bt_container)
        self.bt_task.setObjectName(u"bt_task")
        self.bt_task.setMinimumSize(QSize(0, 40))
        self.bt_task.setContextMenuPolicy(Qt.DefaultContextMenu)
        self.bt_task.setLayoutDirection(Qt.LeftToRight)
        icon5 = QIcon()
        icon5.addFile(u"Media/taskC.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_task.setIcon(icon5)
        self.bt_task.setIconSize(QSize(32, 32))

        self.verticalLayout_2.addWidget(self.bt_task)
        ...
        self.bt_users = QPushButton(self.lateral_bt_container)
        self.bt_users.setObjectName(u"bt_users")
        self.bt_users.setMinimumSize(QSize(0, 40))
        self.bt_users.setStyleSheet(u"")
        icon7 = QIcon()
        icon7.addFile(u"Media/users.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_users.setIcon(icon7)
        self.bt_users.setIconSize(QSize(32, 32))

        self.verticalLayout_2.addWidget(self.bt_users)

        self.lateral_bt_container_spacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.verticalLayout_2.addItem(self.lateral_bt_container_spacer)
        ...
        icon8 = QIcon()
        icon8.addFile(u"Media/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_settings.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u"Media/help.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_help.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u"Media/log-out.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_log_out.setIcon(icon10)
        ...
        self.task_main_title = QLabel(self.task_frame)
        self.task_main_title.setObjectName(u"task_main_title")
        self.task_main_title.setStyleSheet(u"font: 87 15pt \"Arial Black\";")
        self.task_main_title.setAlignment(Qt.AlignCenter)

        self.verticalLayout_19.addWidget(self.task_main_title)

        self.task_above_spacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.verticalLayout_19.addItem(self.task_above_spacer)
...
"}")
        ...
        self.task_option_container_hor_layout = QHBoxLayout()
        self.task_option_container_hor_layout.setObjectName(u"task_option_container_hor_layout")
        self.task_option_container_hor_layout.setSizeConstraint(QLayout.SetDefaultConstraint)
        self.task_bt_search = QPushButton(self.task_option_container)
        self.task_bt_search.setObjectName(u"task_bt_search")
        self.task_bt_search.setIconSize(QSize(20, 20))

        self.task_option_container_hor_layout.addWidget(self.task_bt_search)

        self.task_bt_edit = QPushButton(self.task_option_container)
        self.task_bt_edit.setObjectName(u"task_bt_edit")

        self.task_option_container_hor_layout.addWidget(self.task_bt_edit)


        self.verticalLayout_20.addLayout(self.task_option_container_hor_layout)


        self.verticalLayout_19.addWidget(self.task_option_container)

        self.task_below_spacer = QSpacerItem(10, 10, QSizePolicy.Minimum, QSizePolicy.Minimum)

        self.verticalLayout_19.addItem(self.task_below_spacer)
...
"")
        ...
        self.budget_above_spacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.verticalLayout_16.addItem(self.budget_above_spacer)

        self.budget_options_container = QWidget(self.budget_frame)
        self.budget_options_container.setObjectName(u"budget_options_container")
        sizePolicy3 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.budget_options_container.sizePolicy().hasHeightForWidth())
        self.budget_options_container.setSizePolicy(sizePolicy3)
        self.budget_options_container.setStyleSheet(u"QPushButton{\n"
"border: 2px solid;\n"
"border-color:rgb(0, 0, 0);\n"
"background-color: rgb(85, 85, 255);\n"
"border-radius: 5px;\n"
...
"font: 75 12pt \"Arial Narrow\";\n"
"}")
        self.horizontalLayout_3 = QHBoxLayout(self.budget_options_container)
        self.horizontalLayout_3.setSpacing(7)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(11, 11, 11, 11)
        self.budget_options_container_hor_layout = QHBoxLayout()
        self.budget_options_container_hor_layout.setObjectName(u"budget_options_container_hor_layout")
        self.budget_options_container_hor_layout.setSizeConstraint(QLayout.SetDefaultConstraint)
        self.budget_bt_search = QPushButton(self.budget_options_container)
        self.budget_bt_search.setObjectName(u"budget_bt_search")

        self.budget_options_container_hor_layout.addWidget(self.budget_bt_search)

        self.budget_bt_edit = QPushButton(self.budget_options_container)
        self.budget_bt_edit.setObjectName(u"budget_bt_edit")

        self.budget_options_container_hor_layout.addWidget(self.budget_bt_edit)


        self.horizontalLayout_3.addLayout(self.budget_options_container_hor_layout)


        self.verticalLayout_16.addWidget(self.budget_options_container)

        self.budget_below_spacer = QSpacerItem(10, 10, QSizePolicy.Minimum, QSizePolicy.Minimum)

        self.verticalLayout_16.addItem(self.budget_below_spacer)
        ...
        self.users_card = QWidget()
        self.users_card.setObjectName(u"users_card")
        sizePolicy.setHeightForWidth(self.users_card.sizePolicy().hasHeightForWidth())
        self.users_card.setSizePolicy(sizePolicy)
        self.users_card.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.verticalLayout_5 = QVBoxLayout(self.users_card)
        self.verticalLayout_5.setSpacing(0)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.verticalLayout_5.setContentsMargins(5, 1, 1, 1)
        self.users_main_title = QLabel(self.users_card)
        self.users_main_title.setObjectName(u"users_main_title")
        self.users_main_title.setStyleSheet(u"font: 87 15pt \"Arial Black\";")
        self.users_main_title.setAlignment(Qt.AlignCenter)

        self.verticalLayout_5.addWidget(self.users_main_title)

        self.users_above_spacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.verticalLayout_5.addItem(self.users_above_spacer)

        self.users_panel = QWidget(self.users_card)
        self.users_panel.setObjectName(u"users_panel")
        self.verticalLayout_18 = QVBoxLayout(self.users_panel)
        self.verticalLayout_18.setSpacing(2)
        self.verticalLayout_18.setObjectName(u"verticalLayout_18")
        self.verticalLayout_18.setContentsMargins(0, 0, 0, 0)
        self.users_options_container = QFrame(self.users_panel)
        self.users_options_container.setObjectName(u"users_options_container")
        self.users_options_container.setStyleSheet(u"QPushButton{\n"
"border: 2px solid;\n"
"border-color:rgb(0, 0, 0);\n"
"background-color: rgb(85, 85, 255);\n"
"border-radius: 5px;\n"
...
"font: 75 12pt \"Arial Narrow\";\n"
"}")
        self.users_options_container.setFrameShape(QFrame.StyledPanel)
        self.users_options_container.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_5 = QHBoxLayout(self.users_options_container)
        ...
        self.users_bt_edit = QPushButton(self.users_options_container)
        self.users_bt_edit.setObjectName(u"users_bt_edit")

        self.horizontalLayout_5.addWidget(self.users_bt_edit)


        self.verticalLayout_18.addWidget(self.users_options_container)

        self.users_below_spacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.verticalLayout_18.addItem(self.users_below_spacer)

        self.users_table = QTableWidget(self.users_panel)
        if (self.users_table.columnCount() < 4):
            self.users_table.setColumnCount(4)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.users_table.setHorizontalHeaderItem(0, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.users_table.setHorizontalHeaderItem(1, __qtablewidgetitem19)
        __qtablewidgetitem20 = QTableWidgetItem()
        self.users_table.setHorizontalHeaderItem(2, __qtablewidgetitem20)
        __qtablewidgetitem21 = QTableWidgetItem()
        self.users_table.setHorizontalHeaderItem(3, __qtablewidgetitem21)
        if (self.users_table.rowCount() < 10):
            self.users_table.setRowCount(10)
        __qtablewidgetitem22 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(0, __qtablewidgetitem22)
        __qtablewidgetitem23 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(1, __qtablewidgetitem23)
        __qtablewidgetitem24 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(2, __qtablewidgetitem24)
        __qtablewidgetitem25 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(3, __qtablewidgetitem25)
        __qtablewidgetitem26 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(4, __qtablewidgetitem26)
        __qtablewidgetitem27 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(5, __qtablewidgetitem27)
        __qtablewidgetitem28 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(6, __qtablewidgetitem28)
        __qtablewidgetitem29 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(7, __qtablewidgetitem29)
        __qtablewidgetitem30 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(8, __qtablewidgetitem30)
        __qtablewidgetitem31 = QTableWidgetItem()
        self.users_table.setVerticalHeaderItem(9, __qtablewidgetitem31)
        __qtablewidgetitem32 = QTableWidgetItem()
        self.users_table.setItem(0, 0, __qtablewidgetitem32)
        __qtablewidgetitem33 = QTableWidgetItem()
        self.users_table.setItem(0, 1, __qtablewidgetitem33)
        __qtablewidgetitem34 = QTableWidgetItem()
        self.users_table.setItem(0, 2, __qtablewidgetitem34)
        __qtablewidgetitem35 = QTableWidgetItem()
        self.users_table.setItem(0, 3, __qtablewidgetitem35)
        __qtablewidgetitem36 = QTableWidgetItem()
        self.users_table.setItem(1, 0, __qtablewidgetitem36)
        __qtablewidgetitem37 = QTableWidgetItem()
        self.users_table.setItem(1, 1, __qtablewidgetitem37)
        __qtablewidgetitem38 = QTableWidgetItem()
        self.users_table.setItem(1, 2, __qtablewidgetitem38)
        __qtablewidgetitem39 = QTableWidgetItem()
        self.users_table.setItem(1, 3, __qtablewidgetitem39)
        __qtablewidgetitem40 = QTableWidgetItem()
        self.users_table.setItem(2, 0, __qtablewidgetitem40)
        __qtablewidgetitem41 = QTableWidgetItem()
        self.users_table.setItem(2, 1, __qtablewidgetitem41)
        __qtablewidgetitem42 = QTableWidgetItem()
        self.users_table.setItem(2, 2, __qtablewidgetitem42)
        __qtablewidgetitem43 = QTableWidgetItem()
        self.users_table.setItem(2, 3, __qtablewidgetitem43)
        __qtablewidgetitem44 = QTableWidgetItem()
        self.users_table.setItem(3, 0, __qtablewidgetitem44)
        __qtablewidgetitem45 = QTableWidgetItem()
        self.users_table.setItem(3, 1, __qtablewidgetitem45)
        __qtablewidgetitem46 = QTableWidgetItem()
        self.users_table.setItem(3, 2, __qtablewidgetitem46)
        __qtablewidgetitem47 = QTableWidgetItem()
        self.users_table.setItem(3, 3, __qtablewidgetitem47)
        __qtablewidgetitem48 = QTableWidgetItem()
        self.users_table.setItem(4, 0, __qtablewidgetitem48)
        __qtablewidgetitem49 = QTableWidgetItem()
        self.users_table.setItem(4, 1, __qtablewidgetitem49)
        __qtablewidgetitem50 = QTableWidgetItem()
        self.users_table.setItem(4, 2, __qtablewidgetitem50)
        __qtablewidgetitem51 = QTableWidgetItem()
        self.users_table.setItem(4, 3, __qtablewidgetitem51)
        __qtablewidgetitem52 = QTableWidgetItem()
        self.users_table.setItem(5, 0, __qtablewidgetitem52)
        __qtablewidgetitem53 = QTableWidgetItem()
        self.users_table.setItem(5, 1, __qtablewidgetitem53)
        __qtablewidgetitem54 = QTableWidgetItem()
        self.users_table.setItem(5, 2, __qtablewidgetitem54)
        __qtablewidgetitem55 = QTableWidgetItem()
        self.users_table.setItem(5, 3, __qtablewidgetitem55)
        __qtablewidgetitem56 = QTableWidgetItem()
        self.users_table.setItem(6, 0, __qtablewidgetitem56)
        __qtablewidgetitem57 = QTableWidgetItem()
        self.users_table.setItem(6, 1, __qtablewidgetitem57)
        __qtablewidgetitem58 = QTableWidgetItem()
        self.users_table.setItem(6, 2, __qtablewidgetitem58)
        __qtablewidgetitem59 = QTableWidgetItem()
        self.users_table.setItem(6, 3, __qtablewidgetitem59)
        __qtablewidgetitem60 = QTableWidgetItem()
        self.users_table.setItem(7, 0, __qtablewidgetitem60)
        __qtablewidgetitem61 = QTableWidgetItem()
        self.users_table.setItem(7, 1, __qtablewidgetitem61)
        __qtablewidgetitem62 = QTableWidgetItem()
        self.users_table.setItem(7, 2, __qtablewidgetitem62)
        __qtablewidgetitem63 = QTableWidgetItem()
        self.users_table.setItem(7, 3, __qtablewidgetitem63)
        __qtablewidgetitem64 = QTableWidgetItem()
        self.users_table.setItem(8, 0, __qtablewidgetitem64)
        __qtablewidgetitem65 = QTableWidgetItem()
        self.users_table.setItem(8, 1, __qtablewidgetitem65)
        __qtablewidgetitem66 = QTableWidgetItem()
        self.users_table.setItem(8, 2, __qtablewidgetitem66)
        __qtablewidgetitem67 = QTableWidgetItem()
        self.users_table.setItem(8, 3, __qtablewidgetitem67)
        __qtablewidgetitem68 = QTableWidgetItem()
        self.users_table.setItem(9, 0, __qtablewidgetitem68)
        __qtablewidgetitem69 = QTableWidgetItem()
        self.users_table.setItem(9, 1, __qtablewidgetitem69)
        __qtablewidgetitem70 = QTableWidgetItem()
        self.users_table.setItem(9, 2, __qtablewidgetitem70)
        __qtablewidgetitem71 = QTableWidgetItem()
        self.users_table.setItem(9, 3, __qtablewidgetitem71)
        ...
        self.verticalLayout_5.addWidget(self.users_panel)

        self.central_card_container.addWidget(self.users_card)
        ...
        self.settings_email_textbox = QLineEdit(self.settings_email_container)
        self.settings_email_textbox.setObjectName(u"settings_email_textbox")
        self.settings_email_textbox.setReadOnly(True)

        self.verticalLayout_10.addWidget(self.settings_email_textbox)
        ...
        self.settings_label_phone = QLabel(self.settings_phone_container)
        self.settings_label_phone.setObjectName(u"settings_label_phone")
        self.settings_label_phone.setStyleSheet(u"font: 87 15pt \"Arial Black\";")

        self.verticalLayout_11.addWidget(self.settings_label_phone)

        self.settings_textfield_phone = QLineEdit(self.settings_phone_container)
        self.settings_textfield_phone.setObjectName(u"settings_textfield_phone")
        self.settings_textfield_phone.setReadOnly(True)

        self.verticalLayout_11.addWidget(self.settings_textfield_phone)
        ...
        self.lo_out_card = QWidget()
        self.lo_out_card.setObjectName(u"lo_out_card")
        sizePolicy.setHeightForWidth(self.lo_out_card.sizePolicy().hasHeightForWidth())
        self.lo_out_card.setSizePolicy(sizePolicy)
        self.log_out_panel = QWidget(self.lo_out_card)
        self.log_out_panel.setObjectName(u"log_out_panel")
        self.log_out_panel.setGeometry(QRect(0, 0, 601, 561))
        self.verticalLayout_3 = QVBoxLayout(self.log_out_panel)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.log_out_button_log_out = QPushButton(self.log_out_panel)
        self.log_out_button_log_out.setObjectName(u"log_out_button_log_out")
        self.log_out_button_log_out.setStyleSheet(u"QPushButton{\n"
"border: 2px solid;\n"
"border-color:rgb(0, 0, 0);\n"
"background-color: rgb(85, 85, 255);\n"
"border-radius: 5px;\n"
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.log_out_button_log_out)

        self.central_card_container.addWidget(self.lo_out_card)
        ...
        AdminMainWindow.setCentralWidget(self.admin_main_panel)

        self.retranslateUi(AdminMainWindow)

        self.bt_menu.setDefault(False)
        self.central_card_container.setCurrentIndex(5)
    ...
    def retranslateUi(self, AdminMainWindow):
        AdminMainWindow.setWindowTitle(QCoreApplication.translate("AdminMainWindow", u"MainWindow", None))
        self.bt_menu.setText(QCoreApplication.translate("AdminMainWindow", u"Menu", None))
        self.bt_min.setText("")
        self.bt_restore.setText("")
        self.bt_max.setText("")
        self.bt_close.setText("")
        self.bt_task.setText(QCoreApplication.translate("AdminMainWindow", u"Task Management", None))
        self.bt_budget.setText(QCoreApplication.translate("AdminMainWindow", u"Budget Management", None))
        self.bt_users.setText(QCoreApplication.translate("AdminMainWindow", u"Users", None))
        self.bt_settings.setText(QCoreApplication.translate("AdminMainWindow", u"Settings", None))
        self.bt_help.setText(QCoreApplication.translate("AdminMainWindow", u"Help", None))
        self.bt_log_out.setText(QCoreApplication.translate("AdminMainWindow", u"Log Out", None))
        ...
        self.settings_email_label.setText(QCoreApplication.translate("AdminMainWindow", u"Email Address", None))
        self.settings_email_textbox.setText(QCoreApplication.translate("AdminMainWindow", u"example@gmail.com", None))
        self.settings_label_phone.setText(QCoreApplication.translate("AdminMainWindow", u"Phone Number", None))
        self.settings_textfield_phone.setText(QCoreApplication.translate("AdminMainWindow", u"672154987", None))
        self.settings_addr_label.setText(QCoreApplication.translate("AdminMainWindow", u"Address", None))
        self.settings_addr_textfield.setText("")
        self.help_main_title.setText(QCoreApplication.translate("AdminMainWindow", u"Welcome to help page", None))
        self.help_ask_label.setText(QCoreApplication.translate("AdminMainWindow", u"Ask us something, we\u00b4ll respond via Email", None))
        self.log_out_button_log_out.setText(QCoreApplication.translate("AdminMainWindow", u"Log Out", None))
    # retranslateUi
