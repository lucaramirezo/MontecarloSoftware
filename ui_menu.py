...
"}")
        ...
        self.label = QLabel(self.pageUsers)
        self.label.setObjectName(u"label")
        self.label.setStyleSheet(u"font: 87 15pt \"Arial Black\";")
        ...
        self.widgetUserView = QWidget(self.pageUsers)
        self.widgetUserView.setObjectName(u"widgetUserView")
        self.verticalLayout_18 = QVBoxLayout(self.widgetUserView)
        self.verticalLayout_18.setSpacing(2)
        self.verticalLayout_18.setObjectName(u"verticalLayout_18")
        self.verticalLayout_18.setContentsMargins(0, 0, 0, 0)
        self.ButtonsUsersOptions = QFrame(self.widgetUserView)
        self.ButtonsUsersOptions.setObjectName(u"ButtonsUsersOptions")
        self.ButtonsUsersOptions.setStyleSheet(u"QPushButton{\n"
"border: 2px solid;\n"
"border-color:rgb(0, 0, 0);\n"
"background-color: rgb(85, 85, 255);\n"
"border-radius: 5px;\n"
...
"font: 75 12pt \"Arial Narrow\";\n"
"}")
        self.ButtonsUsersOptions.setFrameShape(QFrame.StyledPanel)
        self.ButtonsUsersOptions.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_5 = QHBoxLayout(self.ButtonsUsersOptions)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.UserButton = QPushButton(self.ButtonsUsersOptions)
        self.UserButton.setObjectName(u"UserButton")

        #self.horizontalLayout_5.addWidget(self.UserButton)

        self.EditUserButton = QPushButton(self.ButtonsUsersOptions)
        self.EditUserButton.setObjectName(u"EditUserButton")

        #self.horizontalLayout_5.addWidget(self.EditUserButton)


        #self.verticalLayout_18.addWidget(self.ButtonsUsersOptions)

        self.horizontalSpacer_7 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.verticalLayout_18.addItem(self.horizontalSpacer_7)
        # Table
        self.tableWidget_2 = QtWidgets.QTableWidget(self.pageUsers)
        self.tableWidget_2.setGeometry(QtCore.QRect(0, 60, 521, 341))
        ...
        for row, item in enumerate(table):
                ...
                for col, value in enumerate(values):
                        ...
                        value_item.setTextAlignment(QtCore.Qt.AlignVCenter | QtCore.Qt.AlignLeft)
                        self.tableWidget_2.setItem(row, col, value_item)
        ...
        self.tableWidget_2.setVerticalHeaderLabels(row_headers)

        # Crear la lista de encabezados horizontales
        column_headers = ['List {}'.format(col + 1) for col in range(col_count)]
        # Establecer los encabezados horizontales en la tabla
...
"font: 87 36pt \"Arial Black\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_dos.setText(QCoreApplication.translate("MainWindow", u"Users", None))
        ...
        self.EditUserButton.setText(QCoreApplication.translate("MainWindow", u"Edit User", None))
