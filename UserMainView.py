...
from ui_UserMainView import Ui_UserMainWindow
...
# Eliminar barra de título y establecer opacidad
        ...
        def mouseMoveEvent(event):
            if event.buttons() == QtCore.Qt.LeftButton:
                ...
                event.accept()
        self.ui.user_main_panel.mouseMoveEvent = mouseMoveEvent
        # Acceder a las páginas
        self.ui.bt_task_management.clicked.connect(lambda: self.ui.central_card_container.setCurrentWidget(self.ui.task_card))
